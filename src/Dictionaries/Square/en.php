...
return [
    ...
    'PAYMENT_NOT_REFUNDABLE'=>'The payment is not refundable. For example, the payment has been disputed and is no longer eligible for refunds.',
    ...
    'CARD_DECLINED_CALL_ISSUER'=>'The payment card was declined with a request for the card holder to call the issuer.',
