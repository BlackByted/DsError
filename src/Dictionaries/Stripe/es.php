...
return [
    ...
    'authentication_required'=>'La tarjeta se rechazó porque la transacción requiere autenticación. Por favor volver a intentarlo y autenticar la tarjeta cuando se le solicite durante la transacción. Si el emisor de la tarjeta envía este código de rechazo en una transacción autenticada, debe ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'approve_with_id'=>'No se puede autorizar el pago. Reintenta el pago. Si aun así no se puede procesar, debe ponerse en contacto con el emisor de la tarjeta.',
    'call_issuer'=>'La tarjeta se ha rechazado por un motivo desconocido. Tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'card_not_supported'=>'La tarjeta no acepta este tipo de compras. Por favor ponerse en contacto con el emisor para corroborar si su tarjeta se puede utilizar para hacer este tipo de compras.',
    'card_velocity_exceeded'=>'El cliente ha excedido el límite del saldo o del crédito disponible en su tarjeta. Por favor debe de ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'currency_not_supported'=>'La tarjeta no acepta la divisa especificada. Por favor debe de ponerse en contacto con el emisor para verificar si la tarjeta se puede utilizar para comprar en la divisa especificada.',
    'do_not_honor'=>'La tarjeta se ha rechazado por un motivo desconocido. Por favor tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'do_not_try_again'=>'La tarjeta se ha rechazado por un motivo desconocido. Por favor debe de ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'duplicate_transaction'=>'Hace muy poco se realizó otra transacción por el mismo importe con una tarjeta de crédito con los mismos datos. Verifica si ya existe un pago reciente.',
    'expired_card'=>'La tarjeta ha caducado. Debe utilizar otra tarjeta.',
    'fraudulent'=>'El pago se ha rechazado porque Stripe sospecha que es fraudulento.',
    'generic_decline'=>'La tarjeta se ha rechazado por un motivo desconocido. Por favor tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'incorrect_number'=>'El número de tarjeta no es correcto. Verifique que el número de la tarjeta sea el correcto',
    'incorrect_cvc'=>'El número de CVC no es correcto. Verifique si el CVC introducido es el correcto',
    'incorrect_pin'=>'El PIN introducido es incorrecto. Este código de rechazo solo se aplica a los pagos efectuados con un lector de tarjetas. PIN introducido es incorrecto, vuelva a intentar introducir su PIN correcto',
    'incorrect_zip'=>'El código postal no es correcto. el codigo postal introducido es incorrecto. Por favor ingrese el CP de facturacion correcto',
    'insufficient_funds'=>'La tarjeta no tiene fondos suficientes para hacer la compra. Se recomienda usar otro medio de pago',
    'invalid_account'=>'La tarjeta o la cuenta a la que está conectada la tarjeta no es válida. Verifique si la tarjeta se encuentra se encuentra activa',
    'invalid_amount'=>'El importe del pago no es válido o excede el importe permitido. el importe sobrepasa el importe máximo permitido. Verifique que el importe máximo de su tarjeta sea mayor al que quiere realizar',
    'invalid_cvc'=>'El número de CVC no es correcto. Revise que el CVC sea el correcto y vuelva a intentar lo',
    'invalid_expiry_month'=>'El mes de caducidad no es válido. Revise que el mes de caducacion sea la correcta de su tarjeta',
    'invalid_expiry_year'=>'El año de caducidad no es válido. Revise que el año de caducacion sea la correcta de su tarjeta',
    'invalid_number'=>'El número de tarjeta no es correcto. Verifique su número de tarjeta y vuelva a intentar lo',
    'invalid_pin'=>'El PIN introducido es incorrecto. Este código de rechazo solo se aplica a los pagos efectuados con un lector de tarjetas. Verifique que el PIN introducido sea el correcto',
    'issuer_not_available'=>'No se ha podido establecer contacto con el emisor de la tarjeta, así que no se ha podido autorizar el pago. Reintente el pago, si persiste el fallo, contacte al emisor de la tarjeta',
    'lost_card'=>'El pago se ha rechazado porque la tarjeta figura como tarjeta perdida. El motivo específico del rechazo no debe comunicarse al cliente. Debe presentarse como un rechazo genérico.',
    'merchant_blacklist'=>'El pago se ha rechazado porque coincide con un valor de la lista de bloqueo del usuario de Stripe.',
    'new_account_information_available'=>'La tarjeta o la cuenta a la que está conectada la tarjeta no es válida. Es necesario ponerse en contacto con el emisor de la tarjeta para mas información',
    'no_action_taken'=>'La tarjeta se ha rechazado por un motivo desconocido. Es necesario ponerse en contacto con el emisor de la tarjeta para mas información',
    'not_permitted'=>'El pago no está permitido. Es necesario ponerse en contacto con el emisor de la tarjeta para mas información',
    'offline_pin_required'=>'La tarjeta se ha rechazado porque hace falta un PIN. Reintente el pago y introducir su PIN nuevamente',
    'online_or_offline_pin_required'=>'La tarjeta se ha rechazado porque hace falta un PIN. Si el lector de la tarjeta es compatible con la introducción del PIN en línea, se le debe solicitar el PIN al cliente sin crear una nueva transacción. Si el lector de la tarjeta no es compatible con la introducción del PIN en línea, el cliente deberá intentarlo de nuevo insertando su tarjeta e introduciendo el PIN.',
    'pickup_card'=>'El cliente no puede usar esta tarjeta para efectuar este pago. (Es posible que haya sido denunciada por pérdida o robo). Para obtener más información, debera contactar con el emisor de la tarjeta.',
    'pin_try_exceeded'=>'Se ha superado el número permitido de intentos de introducción del PIN. Intente otro medio de pago u otra trarjeta',
    'processing_error'=>'Ha ocurrido un error mientras se procesaba la tarjeta. Es necesario volver a intentar efectuar el pago. Si aun así sigue sin poder procesarse, vuelve a intentarlo más tarde.',
    'reenter_transaction'=>'El emisor no ha podido procesar el pago por un motivo desconocido. Es necesario volver a intentar efectuar el pago. Si aun así sigue sin poder procesarse, debera ponerse en contacto con el emisor de la tarjeta.',
    'restricted_card'=>'El cliente no puede usar esta tarjeta para efectuar este pago. (Es posible que haya sido denunciada por pérdida o robo). Tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'revocation_of_all_authorizations'=>'La tarjeta se ha rechazado por un motivo desconocido. Tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'revocation_of_all_authorizations'=>'La tarjeta se ha rechazado por un motivo desconocido. Tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'security_violation'=>'La tarjeta se ha rechazado por un motivo desconocido. Tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'service_not_allowed'=>'La tarjeta se ha rechazado por un motivo desconocido. Tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'stolen_card'=>'El pago se ha rechazado porque la tarjeta figura como robada. El motivo específico del rechazo no debe comunicarse al cliente.',
    'stop_payment_order'=>'La tarjeta se ha rechazado por un motivo desconocido. Tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'testmode_decline'=>'Se utilizó el número de una tarjeta de prueba de Stripe. Se debe utilizar una tarjeta real para hacer pagos.',
    'transaction_not_allowed'=>'La tarjeta se ha rechazado por un motivo desconocido. Tiene que ponerse en contacto con el emisor de la tarjeta para obtener más información.',
    'try_again_later'=>'La tarjeta se ha rechazado por un motivo desconocido. Pide el volver a intentarlo. Si se rechazan los pagos sucesivos, deberá contactar con el emisor de la tarjeta para obtener más información.',
    'withdrawal_count_limit_exceeded'=>'El cliente ha excedido el límite del saldo o del crédito disponible en su tarjeta. Intente usar otro método de pago.',
