...
return [
    ...
    'authentication_required'=>'The card was declined as the transaction requires authentication. Please try again and authenticate the card when requested during the transaction. If the card issuer sends this rejection code in an authenticated transaction, you must contact the card issuer for more information.',
    'approve_with_id'=>'The payment can’t be authorized. Reinta the payment. If it still cannot be processed, you must contact the card issuer.',
    'call_issuer'=>'The card was declined for an unknown reason. You have to contact the card issuer for more information.',
    'card_not_supported'=>'The card does not support this type of purchase. Please contact the issuer to corroborate if your card can be used to make this type of purchases.',
    'card_velocity_exceeded'=>'The customer has exceeded the balance or credit limit available on their card. Please you must contact the card issuer for more information.',
    'currency_not_supported'=>'The card does not support the specified currency. Please you must contact the issuer to verify if the card can be used to buy in the specified currency.',
    'do_not_honor'=>'The card was declined for an unknown reason. Please have to contact the card issuer for more information.',
    'do_not_try_again'=>'The card was declined for an unknown reason. Please you must contact the card issuer for more information.',
    'duplicate_transaction'=>'A transaction with identical amount and credit card information was submitted very recently. Verify if there is already a recent payment.',
    'expired_card'=>'The card has expired. You must use another card.',
    'fraudulent'=>'The payment was declined because Stripe suspects that it’s fraudulent.',
    'generic_decline'=>'The card was declined for an unknown reason. Please have to contact the card issuer for more information.',
    'incorrect_number'=>'The card number is incorrect. Verify that the card number is correct',
    'incorrect_cvc'=>'The CVC number is incorrect. Verify if the CVC introduced is correct',
    'incorrect_pin'=>'The PIN entered is incorrect. This decline code only applies to payments made with a card reader. Introduced pin is incorrect, try to introduce your right pin',
    'incorrect_zip'=>'The postal code is incorrect. Please enter the correct billing CP',
    'insufficient_funds'=>'The card has insufficient funds to complete the purchase. It is recommended to use another means of payment',
    'invalid_account'=>'The card, or account the card is connected to, is invalid. Verify if the card is located is active',
    'invalid_amount'=>'The payment amount is invalid, or exceeds the amount that’s allowed. Verify that the maximum amount of your card is greater than you want to make',
    'invalid_cvc'=>'The CVC number is incorrect. Check that the CVC is correct and try again',
    'invalid_expiry_month'=>'The expiration month is invalid. Check that the month of expiration is the correct one of your card',
    'invalid_expiry_year'=>'The expiration year is invalid. Check that the year of expiration is the correct one of your card',
    'invalid_number'=>'The card number is incorrect. Check your card number and try again',
    'invalid_pin'=>'The PIN entered is incorrect. This decline code only applies to payments made with a card reader. Verify that the introduced pin is correct',
    'issuer_not_available'=>'The card issuer couldn’t be reached, so the payment couldn’t be authorized. Refound the payment, if the failure persists, contact the card issuer',
    'lost_card'=>'The payment was declined because the card is reported lost. The specific reason for rejection should not communicate to the client. It must be presented as a generic rejection.',
    'merchant_blacklist'=>'The payment was declined because it matches a value on the Stripe user’s block list.',
    'new_account_information_available'=>'The card, or account the card is connected to, is invalid. It is necessary to contact the card issuer for more information',
    'no_action_taken'=>'The card was declined for an unknown reason. It is necessary to contact the card issuer for more information',
    'not_permitted'=>'The payment isn’t permitted. It is necessary to contact the card issuer for more information',
    'offline_pin_required'=>'The card was declined because it requires a PIN. Refound payment and enter your pin again',
    'online_or_offline_pin_required'=>'The card was declined as it requires a PIN. If the card reader is compatible with the introduction of the online pin, the PIN must be requested from the client without creating a new transaction. If the card reader is not compatible with the introduction of the online pin, the client must try again by inserting his card and introducing the pin.',
    'pickup_card'=>'The customer can’t use this card to make this payment (it’s possible it was reported lost or stolen). For more information, you should contact the card issuer.',
    'pin_try_exceeded'=>'The allowable number of PIN tries was exceeded. Try another means of payment or other trap',
    'processing_error'=>'An error occurred while processing the card. It is necessary to try to make the payment again. If still unable to be processed, try again later.',
    'reenter_transaction'=>'The payment couldn’t be processed by the issuer for an unknown reason. It is necessary to try to make the payment again. If still unable to be processed, you should contact the card issuer.',
    'restricted_card'=>'The customer can’t use this card to make this payment (it’s possible it was reported lost or stolen). You have to contact the card issuer for more information.',
    'revocation_of_all_authorizations'=>'The card was declined for an unknown reason. You have to contact the card issuer for more information.',
    'revocation_of_all_authorizations'=>'The card was declined for an unknown reason. You have to contact the card issuer for more information.',
    'security_violation'=>'The card was declined for an unknown reason. You have to contact the card issuer for more information.',
    'service_not_allowed'=>'The card was declined for an unknown reason. You have to contact the card issuer for more information.',
    'stolen_card'=>'The payment was declined because the card is reported stolen. The specific reason for rejection should not communicate to the client.',
    'stop_payment_order'=>'The card was declined for an unknown reason. You have to contact the card issuer for more information.',
    'testmode_decline'=>'A Stripe test card number was used. A real card to make payments should be used.',
    'transaction_not_allowed'=>'The card was declined for an unknown reason. You have to contact the card issuer for more information.',
    'try_again_later'=>'The card was declined for an unknown reason. Ask to try again. If successive payments are rejected, you must contact the card issuer for more information.',
    'withdrawal_count_limit_exceeded'=>'The customer has exceeded the balance or credit limit available on their card. Try to use another payment method.',
