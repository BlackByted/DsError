...
return [
    ...
    'I00004'=>'No records have been found that match your query.',
    'I00005'=>'The mobile device was successfully inserted into the database.',
    'I00006'=>'The mobile device was successfully registered and approved by the account administrator.',
    'I00007'=>'The Payment Gateway Account service (id=8) has already been accepted.',
    'I00008'=>'The Payment Gateway Account service (id=8) has already been declined.',
    'I00009'=>'The APIUser already exists.',
    'I00010'=>'The merchant is activated successfully.',
    'I00011'=>'The merchant is not activated.',
    'I99999'=>'This is a work in progress. This message will not be released to production. It’s just a dev placeholder.',
    ...
    'E00006'=>'User authentication requires a valid value for API user name.',
    ...
    'E00020'=>'The payment gateway account is not set up to process eCheck.Net subscriptions.',
    'E00021'=>'The payment gateway account is not set up to process credit card subscriptions.',
    'E00022'=>'The interval length must be 7 to 365 days or 1 to 12 months.',
    'E00023'=>'The number of total occurrences cannot extend the duration of the subscription beyond three years from the start date.',
    ...
    'E00034'=>'Once a subscription is created the interval cannot be changed.',
    ...
    'E00047'=>'The reseller account is not enabled for Merchant Boarding API.',
    'E00048'=>'The merchant account must be set up to accept credit card payments, eCheck payments, or both.',
    'E00049'=>'The database operation timed out before it could be completed.',
    'E00050'=>'Cannot set a buyrate to less than the sellrate',
    'E00051'=>'If customer profile ID, payment profile ID, and shipping address ID are included, they must match the original transaction.',
    'E00052'=>'The maximum number of elements for an array has been reached.',
    'E00053'=>'The server is currently too busy, please try again later.',
    'E00054'=>'The mobile device identifier is not associated with the merchant account.',
    'E00055'=>'The mobile device exists but is in a pending status.',
    'E00056'=>'The mobile device exists but has a status of disabled.',
    'E00057'=>'The user does not have sufficient permissions to use a mobile device with this merchant account.',
    'E00058'=>'The merchant has too many devices in a pending status.',
    'E00059'=>'The authentication type is not allowed for the requested method call.',
    ...
    'E00067'=>'This is the result of an XML parser error. Too many nodes specified.',
    'E00068'=>'This is the result of an XML parser error. The node is invalid.',
    ...
    'E00071'=>'All of the fields were empty or missing.',
    'E00072'=>'Required node missing.',
    'E00073'=>'One of the field values is not valid.',
    'E00074'=>'This merchant is not associated with this reseller.',
    'E00075'=>'This is the result of an XML parser error. Missing field(s).',
    'E00076'=>'Invalid value.',
    'E00077'=>'Value too long.',
    'E00078'=>'Pending Status (not completed).',
    'E00079'=>'Impersonation partner login ID is invalid or not present.',
    'E00080'=>'Impersonation API Key is invalid or not present.',
    ...
    'E00087'=>'There are no subscriptions available for the merchant account for the type of subscriptions requested.',
    'E00088'=>'CreateProfile and profileIds are mutually exclusive, only one of them can be provided at a time.',
    'E00089'=>'When requesting CreateProfile payment data cannot be null.',
    'E00090'=>'PaymentProfile and PaymentData are mutually exclusive, only one of them can be provided at a time.',
    'E00091'=>'PaymentProfileId and payment data are mutually exclusive, only one of them can be provided at a time.',
    'E00092'=>'ShippingProfileId and ShipToAddress are mutually exclusive, only one of them can be provided at a time.',
    'E00093'=>'PaymentProfile and Billing information are mutually exclusive, only one of them can be provided at a time.',
    'E00094'=>'Paging Offset exceeds allowed value. Check and lower the value.',
    'E00095'=>'When using Customer Profile with Credit Card Info to specify Shipping Profile, Shipping Profile Id must be included.',
    'E00096'=>'Finger Print value is not valid.',
    'E00097'=>'Finger Print can’t be generated.',
    'E00098'=>'Search for shipping profile using customer profile id and shipping profile id did not find any records.',
    ...
    'E00101'=>'Error creating a customer payment profile from transaction.',
    'E00102'=>'Error creating a customer profile from transaction.',
    ...
    'E00108'=>'CustomerProfileId and Customer data are mutually exclusive, only one of them can be provided for any single request.',
    'E00109'=>'Shipping Address ID and Shipping data are mutually exclusive, only one of them can be provided for any single request.',
    'E00110'=>'When using Customer Profile, CustomerPaymentProfileId must be included.',
    'E00111'=>'If Customer Profile ID is included, it must match the Customer Profile ID used for the original subscription.',
    'E00112'=>'Reports cannot be generated for future dates, thus the specified date is invalid.',
    'E00113'=>'The specified OTS Token Data is invalid.',
    'E00114'=>'The specified OTS Token is invalid.',
    'E00115'=>'The specified OTS Token has expired.',
    'E00116'=>'The authenticated merchant does not have access to the specified OTS Token.',
    'E00117'=>'The OTS Service cannot complete the request due to a validation or configuration error.',
    'E00118'=>'The transaction was submitted from a blocked IP address.',
    'E00119'=>'Hosted Payment Page will capture the payment (bank/card) information so this information should not be included with this request.',
    'E00120'=>'Payment and Shipping Profile IDs cannot be specified when creating new profiles.',
    'E00121'=>'The customer profile does not have a default payment/shipping profile.',
    'E00122'=>'Signature key missing.',
    ...
    'E00127'=>'Invoice number did not find any records.',
    ...
    'E00131'=>'Invoice created but failed send email and update status',
    'E00132'=>'The payment gateway account is not enabled for Invoicing or CIM service.',
    'E00133'=>'Server error',
    'E00134'=>'Due date is past date or not specified.',
    'E00135'=>'Merchant has not yet provided processor information to set test mode flag to false.',
    'E00136'=>'Processor account has not been setup to set test mode flag to false.',
    ...
    'E00139'=>'The Access token does not have permission to call the API method.',
    ...
    'E00143'=>'Failed to parse the MerchantId to integer',
